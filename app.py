...
departure1 = {"msk": "Из Москвы", "spb": "Из Петербурга", "nsk": "Из Новосибирска", "ekb": "Из Екатеринбурга",
              "kazan": "Из Казани"}
...
tourS = {
    ...
    4: {
        ...
        "description": "Каждый домик оборудован средней кухней и одной небольшой ванной комнатой, "
                       ...
                       "Небольшие треугольные окна добавляют к общему стилю дома и"
                       " были добавлены в дом в основном симметричным способом.",
        "departure": "msk",
        "picture": "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixlib=rb-1.2."
    ...
    9: {
        ...
        "description": "Этот большой дом имеет сказочный вид и находится в отличном состоянии. Интерьер выполнен в "
                       ...
                       "недавно созданной земли, а дом имеет большой решетчатый забор через него. На заднем дворе живут"
                       " различные животные. Многие владельцы приложили согласованные усилия для поддержания этой "
                       "собственности.",
        "departure": "nsk",
        "picture": "https://images.unsplash.com/photo-1570214476695-19bd467"
                   "e6f7a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60",
        "price": 39000,
        "stars": "3",
        "country": "Индия",
        "nights": 10,
    ...
    10: {
        ...
        "departure": "msk",
        "picture": "https://images.unsplash.com/photo-1560200353-ce0a76b1d438?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9"
    ...
    11: {
        ...
        "description": "В доме очень хороший двор с большими камнями, похожими на озеро. В задней части дома окна "
                       ...
                       "маленьких деревьев. Двор в очень хорошем состоянии и очень живописный. "
                       "Есть пруд для развлечения",
        "departure": "spb",
        "picture": "https://images.unsplash.com/photo-1477120128765-a0528148fed2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyM"
    ...
    12: {
        ...
        "description": "Дом оборудован огромной кухней и одной современной ванной комнатой, а также имеет огромную гост"
                       "иную, две спальни, небольшую столовую, гостиную и скромную кладовую.  Дом чистый, хорошо постро"
                       "енный и в хорошем состоянии, но, к сожалению, кровати сгорели в мае этого года и, к сожалению, "
                       "все еще нуждаются в ремонте. Возможно, понадобится целая команда, чтобы заменить старую медную "
                       "топку.",
        "departure": "kazan",
        "picture": "https://images.unsplash.com/photo-1440151050977-247552660a3b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyM"
                   "Dd9&auto=format&fit=crop&w=800&q=60",
        "price": 72000,
        "stars": "4",
        "country": "Мексика",
    ...
    13: {
        ...
        "description": "Снаружи этот дом выглядит очень элегантно. Он был построен из коричневого кирпича и имеет "
                       ...
                       "цветов.",
        "departure": "ekb",
        "picture": "https://images.unsplash.com/photo-1553653924-39b70295f8da?ixlib=rb-1.2.1&auto=format&fit=crop&w=8"
                   "00&q=60",
        "price": 49000,
        "stars": "3",
        "country": "Куба",
    ...
    14: {
        ...
        "description": "Крыша высокая, треугольная, многослойная, покрыта пшеничной соломой. Две большие трубы "
                       "находятся"
                       " по обе стороны от дома. Многие меньшие окна пропускают много света в комнаты под крышей.Сам "
                       "дом"
                       " окружен асфальтированной землей, с местом для еды и отдыха на открытом воздухе и различными "
                       "горшечными растениями.",
        "departure": "kazan",
        "picture": "https://images.unsplash.com/photo-1509600110300-21b9d5fedeb7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMD"
                   "d9&auto=format&fit=crop&w=800&q=60",
        "price": 91000,
        "stars": "5",
        "country": "Вьетнам",
        "nights": 9,
    ...
    15: {
        ...
        "description": "Здание имеет форму круга. Дом частично окружен деревянными нависающими панелями с двух сторон."
                       " Второй этаж меньше первого, что позволило создать несколько балконов по бокам дома. Этот этаж "
                       "следует тому же стилю, что и этаж ниже.",
        "departure": "spb",
        "picture": "https://images.unsplash.com/photo-1568084680786-a84f91d1153c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyM"
                   "Dd9&auto=format&fit=crop&w=800&q=60",
        "price": 82000,
        "stars": "4",
        "country": "Доминикана",
    ...
    16: {
        ...
        "departure": "spb",
        "picture": "https://images.unsplash.com/photo-1564056095795-4d63b6463dbf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEy"
                   "MDd9&auto=format&fit=crop&w=800&q=60",
        "price": 74000,
        "stars": "5",
        "country": "Вьетнам",
        "nights": 12,
...
@app.route('/')
def main():
    shuffled_figures = [i for i in range(1, 17)]   # Для вывода случайных туров в index.html
